...
<head>
    ...
    <title>IE Compatibility | Airtec</title>
    ...
    <meta property="og:title" content="IE Compatibility" />
...
<meta name="VIcurrentDateTime" content="636135781475642012" />
...
<div class="section-title">
    <div class="container">
        <div class="row">
            <h2>Get the Most from This Site Using the Latest Browsers</h2>
        </div>
    </div>
</div>
...
<div class="content-intro block">
    <div class="content clearfix">
        <div class="page-title">
            <h1>UPGRADE OR TURN OFF COMPATIBILITY VIEW FOR THE BEST EXPERIENCE</h1>
        ...
        <div class="copy ">
            <h4></h4>
            <p>Our new website features, such as our mega menu, interactive global locations map and more work best with today&rsquo;s modern browsers. Get the most out of the site by upgrading your browser and making sure that IE Compatibility View is turned off.</p>
<p>Don&rsquo;t have the latest? Use these links to upgrade your browser today! And if you&rsquo;re using Internet Explorer version 8 or above, please turn off Compatibility View.</p>
<p>For the latest browsers:<br>
<a href="http://windows.microsoft.com/en-us/internet-explorer/download-ie" target="_blank" class="with_external">Microsoft Internet Explorer</a><br>
<a href="www.google.com/intl/en/chrome/browser/browser.php" target="_blank" class="with_external">Google Chrome</a><br>
<a href="www.apple.com/safari/safari.php" target="_blank" class="with_external">Apple Safari</a></p>
<p>For information on Internet Explorer compatibility view, visit <a href="http://windows.microsoft.com/en-us/internet-explorer/use-compatibility-view#ie=ie-8" target="_blank">Microsoft.com</a>.</p>
        </div>
    </div>
</div>
                </div>
