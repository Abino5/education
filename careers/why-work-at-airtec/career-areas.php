...
<head>
    ...
    <title>Airtec Career Areas | Airtec</title>

        <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="IE=EDGE" />

    <meta name="description" content="Explore the career areas and roles we hire for and see first hand the opportunities available at Airtec." />
    <meta name="keywords" content="" />

    <meta property="og:title" content="Airtec Career Areas" />
    <meta property="og:description" content="Explore the career areas and roles we hire for and see first hand the opportunities available at Airtec." />
...
<meta name="VIcurrentDateTime" content="636135781364882722" />
            ...
            <div class="sub-careers-col omega">
                ...
                <div class="menu-cols-wrap">
                    <div class="menu-cols col-two">
                            <div class="menu-col">
                                <h4><a href='../why-work-at-airtec.php' target='Active Browser' >Why Work at Airtec</a></h4>
                                <ul>
                                        <li><a href="career-areas.php" title="Career Areas">Career Areas</a></li>
    ...
    <div class="container">
        <div class="row">
            <ul class="crumbs clearfix">
                    ...
                    <li>
                        <a href="../why-work-at-airtec.php" title="Why Work at Airtec">Why Work at Airtec</a>
                    </li>
                <li class="current">
...
<div class="content-intro block">
    <div class="content clearfix">
        ...
        <div class="copy ">
            <h4>Find your area of expertise</h4>
            <p>Learn more about the departments, functions and roles at Airtec and explore the breadth of opportunities we have to offer.</p>
        </div>
    </div>
</div>
</div>
...
<div class="accordions">
        <div class="toggler-all">
                <a href="career-areas.php#" class="expand">Expand All</a>

                <a href="career-areas.php#" class="collapse">Collapse All</a>
        </div>

        <div class="toggler" data-accordion="false">
            <div class="trigger">
                <h2>Drivers <span class="toggler-icon">-</span></h2>
            </div>
    ...
    <div class="content clearfix">
      <div class="copy">
          <p>Our customers&rsquo; productivity is in your hands. Help us ensure our products arrive when and where our industrial, packaged and merchant customers need them. Join our fleet and be an essential part of our commitment to delivering uninterrupted supply.</p>
      </div>
    </div>
</div>
                    </div>
                    ...
                    <div class="back-to-top">
                        <p>
                            <a href="career-areas.php#"><span class="arrow_top">^</span>Back to Top</a>
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="toggler" data-accordion="false">
            <div class="trigger">
                <h2>Engineering <span class="toggler-icon">-</span></h2>
            </div>
    ...
    <div class="content clearfix">
      <div class="copy">
          <p>Define your future as a builder and a problem solver. From designing blueprints to managing the construction of new plants, every thing you create and every project you complete supports our mission of <em>Making our plant more productive</em>.</p>
      </div>
    </div>
</div>
                    </div>
        ...
        <div class="toggler" data-accordion="false">
            <div class="trigger">
                <h2>Finance & Accounting <span class="toggler-icon">-</span></h2>
            </div>
    ...
    <div class="content clearfix">
      <div class="copy">
          <p>Join our team of high-caliber professionals and work to maintain and improve the financial health and profitability of our company. The work you do allows us to continue to provide the products, technologies and services our customers need to become more efficient.</p>
      </div>
    </div>
</div>
                    </div>
        ...
        <div class="toggler" data-accordion="false">
            <div class="trigger">
                <h2>Human Resources <span class="toggler-icon">-</span></h2>
            </div>
    ...
    <div class="content clearfix">
      <div class="copy">
          <p>From the hiring process through skill and leadership development, support our employees and the managers who guide them as they grow in their careers. At Airtec, our people are our most valuable Assets and through exposure to compensation and benefits strategies and development techniques, you will play a vital role in helping us hire and retain the keys to our success.</p>
      </div>
    </div>
</div>
                    </div>
        ...
        <div class="toggler" data-accordion="false">
            <div class="trigger">
                <h2>Information Technology <span class="toggler-icon">-</span></h2>
            </div>
    ...
    <div class="content clearfix">
      <div class="copy">
          <p>Solve challenging business issues and enable company growth with leading-edge information technology. The work you do on our applications and technologies helps us create innovative solutions for our customers, and gives us a competitive advantage in the industry.</p>
      </div>
    </div>
</div>
                    </div>
        ...
        <div class="toggler" data-accordion="false">
            <div class="trigger">
                <h2>Legal <span class="toggler-icon">-</span></h2>
            </div>
    ...
    <div class="content clearfix">
      <div class="copy">
          <p>As we grow our presence in emerging markets all over the world, provide counsel to our leaders on a wide range of legal and ethical issues surrounding international business. Ensure that our company conducts affairs in a legal manner around the globe and work to keep our intellectual property secure.</p>
      </div>
    </div>
</div>
                    </div>
        ...
        <div class="toggler" data-accordion="false">
            <div class="trigger">
                <h2>Marketing & Business Development <span class="toggler-icon">-</span></h2>
            </div>
    ...
    <div class="content clearfix">
      <div class="copy">
          <p>Collaborate with thousands of customers, markets and industries around the world to bring efficient and effective solutions to millions. Blend a deep understanding of the market with science and technology to continuously deliver best-in-class products, applications and services to our customers.</p>
      </div>
    </div>
</div>
                    </div>
        ...
        <div class="toggler" data-accordion="false">
            <div class="trigger">
                <h2>Operations <span class="toggler-icon">-</span></h2>
            </div>
    ...
    <div class="content clearfix">
      <div class="copy">
          <p>Drive down cost and drive up value by optimizing efficiency in every step of our manufacturing and distribution processes. Direct the production of our industrial and specialty gas products and improve the quality of our program design to increase yield.</p>
      </div>
    </div>
</div>
                    </div>
        ...
        <div class="toggler" data-accordion="false">
            <div class="trigger">
                <h2>Procurement & Materials Management <span class="toggler-icon">-</span></h2>
            </div>
    ...
    <div class="content clearfix">
      <div class="copy">
          <p>Look at procurement beyond the traditional aspects of cost, quality and consistent supply &mdash; purchasing from suppliers who share our values and ethics. Leverage our programs, policies and associates involved in purchasing decisions around the globe to raise procurement standards and continuously improve our practices.</p>
      </div>
    </div>
</div>
                    </div>
        ...
        <div class="toggler" data-accordion="false">
            <div class="trigger">
                <h2>Productivity <span class="toggler-icon">-</span></h2>
            </div>
    ...
    <div class="content clearfix">
      <div class="copy">
          <p>The more productive we are, the more productive we can make our customers. Implement new systems and design creative solutions to consistently improve the efficiency of our organization. As a member of our team you will prepare detailed plans, drive performance and ensure timely completion of projects, all while achieving quality and savings goals.</p>
      </div>
    </div>
</div>
                    </div>
        ...
        <div class="toggler" data-accordion="false">
            <div class="trigger">
                <h2>Sales <span class="toggler-icon">-</span></h2>
            </div>
    ...
    <div class="content clearfix">
      <div class="copy">
          <p>Be at the forefront of maintaining and building our company&rsquo;s reputation. Choose the right markets and customers, design and effectively articulate value propositions, and transform the voice of our customers into real, applicable solutions.</p>
      </div>
    </div>
</div>
                    </div>
                ...
                <div class="sidebar">
                    <div><div class="sidebar-block cta">
  <h3>Contact Us</h3>
  <h4></h4>
  ...
  <div class="sidebar-block-content">
    <p>+965 1 844844</p>
<p><a href="../../contact-us.php">Airtec contact information</a></p>
  </div>
</div></div>
