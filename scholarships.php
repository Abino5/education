...
<head>
    ...
    <title>Industrial Gases, Products, Systems & Applications by Industry | Airtec</title>

        <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="IE=EDGE" />

    <meta name="description" content="Explore the depth and breadth of industries we serve and see how Airtec can help you make your business more productive." />
    <meta name="keywords" content="" />

    <meta property="og:title" content="Industrial Gases, Products, Systems &amp; Applications by Industry" />
    <meta property="og:description" content="Explore the depth and breadth of industries we serve and see how Airtec can help you make your business more productive." />
...
<meta name="VIcurrentDateTime" content="636135781230879581" />
...
<li>
    <img src='-/media/images/3_0-industries/3_0_praxairgeneric_airtec_1400x298.jpg' alt='3_0_praxairgeneric_Airtec_1400x298.jpg' />
</li>            </ul>
        </div>
    </div>
...
<div class="content-intro block">
    <div class="content clearfix">
        <div class="page-title">
            <h1>INDUSTRIAL GASES, PRODUCTS, SYSTEMS & APPLICATIONS BY INDUSTRY</h1>
        ...
        <div class="copy ">
            <h4>We’re helping you make the most of your resources</h4>
            <p>Here at Airtec, we don&rsquo;t like to waste &mdash; not money, not time and definitely not energy. That&rsquo;s why everything we do is focused on helping you do business more effectively. We offer a full range of atmospheric, process, industrial and specialty gases, and we tailor supply systems to get them to you safely and efficiently. We develop and continue to advance industrial applications and products that help you enhance productivity while reducing emissions. And we offer a full range of industrial services to assist you every step of the way.&nbsp;</p>
<p><span style="line-height: 1.714;">Our resources are important to us. And we know how important they are to you. Take a look at the industries we serve and see how we&rsquo;re helping our customers do more with less.</span></p>
        </div>
    </div>
</div>
    ...
    <div class="linktree">
            <div class="linktree-column">
                <ul>
                                    <li>
                                        <h3>
                                            <a href="industries/evaluation-criteria.php" title="Aerospace &amp; Aircraft">Aerospace & Aircraft</a>
                                        </h3>
                                    </li>
                                    <li>
                                        <h3>
                                            <a href="industries/apply-for-scholarship.php" title="Automotive Fabrication">Automotive Fabrication</a>
                                        </h3>
                                    </li>
                                    <li>
                                        <h3>
                                            <a href="industries/application-timeline.php" title="Chemicals">Chemicals</a>
                                        </h3>
                                    </li>
                                    <li>
                                        <h3>
                                            <a href="industries/request-scholarship-payment.php" title="Diving">Diving</a>
                                        </h3>
                                    </li>
                                    <li>
                                        <h3>
                                            <a href="industries/electronics.php" title="Electronics">Electronics</a>
                                        </h3>
                                    </li>
                                    <li>
                                        <h3>
                                            <a href="industries/energy.php" title="Energy">Energy</a>
                                        </h3>
                                    </li>
                </ul>
            </div>
            <div class="linktree-column">
                <ul>
                                    <li>
                                        <h3>
                                            <a href="industries/food-and-beverage.php" title="Food &amp; Beverage">Food & Beverage</a>
                                        </h3>
                                    </li>
                                    <li>
                                        <h3>
                                            <a href="industries/glass.php" title="Glass">Glass</a>
                                        </h3>
                                    </li>
                                    <li>
                                        <h3>
                                            <a href="industries/healthcare-and-medical.php" title="Healthcare">Healthcare</a>
                                        </h3>
                                    </li>
                                    <li>
                                        <h3>
                                            <a href="industries/laboratories.php" title="Laboratories">Laboratories</a>
                                        </h3>
                                    </li>
                                    <li>
                                        <h3>
                                            <a href="industries/metal-production.php" title="Metal Production">Metal Production</a>
                                        </h3>
                                    </li>
                                    <li>
                                        <h3>
                                            <a href="industries/become-a-volunteer.php" title="Oil &amp; Gas">Oil & Gas</a>
                                        </h3>
                                    </li>
                </ul>
            </div>
            <div class="linktree-column">
                <ul>
                                    <li>
                                        <h3>
                                            <a href="industries/pharmaceuticals-and-biotechnology.php" title="Pharmaceuticals &amp; Biotechnology">Pharmaceuticals & Biotechnology</a>
                                        </h3>
                                    </li>
                                    <li>
                                        <h3>
                                            <a href="industries/pulp-and-paper.php" title="Pulp &amp; Paper">Pulp & Paper</a>
                                        </h3>
                                    </li>
                                    <li>
                                        <h3>
                                            <a href="industries/refining.php" title="Refining">Refining</a>
                                        </h3>
                                    </li>
                                    <li>
                                        <h3>
                                            <a href="industries/water-and-wastewater-treatment.php" title="Water &amp; Wastewater Treatment">Water & Wastewater Treatment</a>
                                        </h3>
                                    </li>
                                    <li>
                                        <h3>
                                            <a href="industries/welding-and-metal-fabrication.php" title="Welding &amp; Metal Fabrication">Welding & Metal Fabrication</a>
                                        </h3>
                                    </li>
                </ul>
            </div>
