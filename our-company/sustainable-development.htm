...
<head>
    ...
    <title>Sustainable Development | Airtec</title>

        <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="IE=EDGE" />

    <meta name="description" content="At Airtec, we provide technologies, products and services that will sustain and protect our planet." />
    <meta name="keywords" content="" />

    <meta property="og:title" content="Sustainable Development" />
    <meta property="og:description" content="At Airtec, we provide technologies, products and services that will sustain and protect our planet." />
...
<meta name="VIcurrentDateTime" content="636135781436174265" />
...
<div class="content-intro block">
    <div class="content clearfix">
        ...
        <div class="copy ">
            <h4>Working to sustain and protect our planet</h4>
            <p>Working with Praxair, Inc., our U.S. joint venture partner, we offer technologies, products and services that support our mission of <em>making our planet more productive</em>. We are committed to improving our customers&rsquo; environmental performance. And we do that by developing and implementing applications that help customers reduce operating costs, increase process efficiencies and improve their environmental performance.</p>
        </div>
    </div>
</div><div class="content-intro block">
    <div class="content clearfix">
        <div class="page-title">
            <h2>Green Technologies & Climate Change</h2>
        </div>
      <div class="copy">
          <h3>DOING MORE WITH LESS</h3>
<p>Airtec and Praxair provide innovative technologies that drive economic growth and social value &mdash; all while using fewer natural resources and less carbon. In doing so, we&rsquo;re helping our customers increase their productivity and in many cases, solving environmental challenges.</p>
<p>To see how we&rsquo;re helping our customers do more with less, take a look at Praxair's U.S. website:&nbsp;<br />
<a href="../www.praxair.com/our-company/sustainable-development/climate-change.htm" target="_blank" class="with_external">Green Technologies &amp; Climate Change</a></p>
      </div>
    </div>
</div><div class="content-intro block">
    <div class="content clearfix">
        <div class="page-title">
            <h2>External Recognition</h2>
        </div>
      <div class="copy">
          <p>Praxair works hard to achieve excellence in sustainability and climate change management, innovation and reporting and have been recognized repeatedly by leading socially responsible investment analyst groups and others for our efforts.</p>
<p>For a summary of how Praxair has been recognized, take a look at their U.S. website:&nbsp;<br />
<a href="../www.praxair.com/our-company/sustainable-development/recognition.htm" target="_blank" class="with_external">Recognition</a></p>
      </div>
    </div>
</div>
                </div>
...
<div class="sidebar-block toggler open">
  <div class="related-links ">
    ...
    <div class="sidebar-block-content toggle-wrapper">
        <ul>
            <li>
              <a href="suppliers/expectations.htm" title="Expectations"><span>Expectations</span></a>
            </li>
        </ul>
    </div>
  </div>
