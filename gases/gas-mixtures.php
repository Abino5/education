...
<head>
    ...
    <title>Gas Mixtures & Gas Blends | Airtec</title>

        <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="IE=EDGE" />

    <meta name="description" content="At Airtec, we offer customized gas mixtures of the highest safety and quality standards for the industries we serve." />
    <meta name="keywords" content="" />

    <meta property="og:title" content="Gas Mixtures &amp; Gas Blends" />
    <meta property="og:description" content="At Airtec, we offer customized gas mixtures of the highest safety and quality standards for the industries we serve." />
...
<meta name="VIcurrentDateTime" content="636135781189851844" />
...
<div class="content-intro block">
    <div class="content clearfix">
        ...
        <div class="copy ">
            <h4>Adding accuracy and stability to the mix </h4>
            <p>At Airtec, we can offer the flexibility of supplying customized gas mixtures to the industries we serve.&nbsp; And with decades of experience in producing mixtures, we apply all the highest safety and quality standards to every blend we create.</p>
        </div>
    </div>
</div>
</div>
...
<div class="content-wrapper clearfix">
    ...
    <div class="block-grid-row clearfix">
            <div class="item bucket ">
                <div class="header">
                <span>Food Gas Mixtures</span>

</div>
<div class="content">
        <p>Composed of nitrogen, oxygen and carbon dioxide,&nbsp;our food gas mixtures greatly reduce microbial growth, delay spoilage and slow enzymatic and biochemical degradation. Protect product flavor, aroma and texture, and extend shelf life without the use of preservatives.</p>
            ...
            <div class="item bucket ">
                <div class="header">
                <span>Helium Shielding and Welding Gas Mixtures</span>

</div>
<div class="content">
        <p>Ensure precision high quality welds in the most pressing environments with Airtec's&nbsp;helium welding and shielding&nbsp;blends. Available in a variety of precise formulas, there are blends to meet your GMAW, GTAW, PAW and laser welding needs.</p>
    ...
    <div class="block-grid-row clearfix">
            <div class="item bucket ">
                <div class="header">
                <span>Hydrogen Shielding and Welding Gas Mixtures</span>

</div>
<div class="content">
        <p>Our hydrogen-enhanced blends are available in a wide range of precision formulations for top-quality welding and cutting applications. So if you're looking to enhance the quality of your welds in GMAW, GTAW or plasma welding, gouging or cutting applications, there are blends to meet your demands.</p>
            ...
            <div class="item bucket ">
                <div class="header">
                <span>Laser Gas Mixtures</span>

</div>
<div class="content">
        <p>Our laser gas mixtures are used to generate the beam in a wide variety of carbon dioxide lasers. When used with a properly designed delivery system, these blends can help you achieve optimum laser performance, maximum operating duty cycle, and minimum maintenance costs.</p>
    ...
    <div class="block-grid-row clearfix">
            <div class="item bucket ">
                <div class="header">
                <span>Mig Welding Gas Mixtures</span>

</div>
<div class="content">
        <p>Spend more time welding and less time cleaning with our&nbsp;mig blends for greater productivity. Users report reduced spatter, less fume with little or no residual slag, so there is little to no post-weld cleanup.</p>
...
<div class="content">
        <p>Our medical gases offer the highest levels of purity, consistency and compliance with government regulations -- enhancing the quality of your medical, pharmaceutical and biotechnology work and improve productivity.</p>
    ...
    <div class="block-grid-row clearfix">
            <div class="item bucket ">
                <div class="header">
                <span>Sterilizing Gas</span>

</div>
<div class="content">
        <p>A carbon dioxide based sterilant gas, sterilizing gas is a non-flammable mixture with an active ingredient of ethylene oxide.</p>
            ...
            <div class="item bucket ">
                <div class="header">
                <span>Medical Gas Mixtures</span>

</div>
<div class="content">
        <p>These consist of the following kinds of mixtures: lung diffusion, blood gas analyzing, incubator, respiratory, anesthetic and biological cultivation.  And they can be customized base on your application.</p>
    ...
    <div class="block-grid-row clearfix">
            <div class="item bucket ">
                <div class="header">
                <span>Environmental Monitoring Mixtures</span>

</div>
<div class="content">
        <p>These include air monitoring, emission and exhaust monitoring mixtures. They can be customized based on your application.</p>
            ...
            <div class="item bucket ">
                <div class="header">
                <span>Gas Detector Calibration Mixtures</span>

</div>
<div class="content">
        <p>These include calibration mixtures for toxic gas detectors, flammable gas detectors and LEL mixtures.&nbsp; They can be customized based on your application.</p>
    ...
    <div class="block-grid-row clearfix">
            <div class="item bucket full">
                <div class="header">
                <span>Gas Chromatography and Analyzer Calibration Mixtures</span>

</div>
<div class="content">
        <p>These include both liquid and gas phase hydrocarbon-based mixtures used to calibrate gas chromatographs and refinery gas analyzers.&nbsp; They can be customized based on your application.</p>
