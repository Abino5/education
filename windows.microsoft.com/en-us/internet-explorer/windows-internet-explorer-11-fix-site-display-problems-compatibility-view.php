...
<!DOCTYPE html>
<html ng-app="SelfAssistWeb" text-direction ng-controller="PageController" lang="{{locale}}" xml:lang="{{locale}}">
<head>
    <meta charset="utf-8" />
    ...
    <link rel="stylesheet" type="text/css" href="https://Assets.onestore.ms/cdnfiles/external/webcore/4.14.0/stylesheets/WebCore.4.14.0.ltr.light.min.css" />
    <link href="/bundles/css?v=VHuT3Xwopm_CnzTQBcg_7CzN8fwUF4UCJFqsKX09Sik1" rel="stylesheet"/>



    <link href="/bundles/print?v=hXL0y6-R0CD68GMcxQRjdH6yaBuWEjj4ysR3flsEvoI1" rel="stylesheet" type="text/css" media="print" />

 

<link href="https://Assets.onestore.ms/cdnfiles/onestorerolling-1610-13000/shell/v3/scss/shell.min.css" rel="stylesheet" type="text/css" />

<!--[if lte IE 8]>
    <link href="https://Assets.onestore.ms/cdnfiles/onestorerolling-1610-13000/shell/common/respond-proxy.php" id="respond-proxy" rel="respond-proxy"/>
<![endif]-->
    <!--[if lt IE 9]>
         <link href="/bundles/ie8?v=NaqsDACovXQRo_hqR6iUPF_YiAg2YvoiDDL6mXfyslM1" rel="stylesheet"/>

    <![endif]-->
    <!-- assembly version 1.0.16301.7, built on 10/27/2016 6:06:35 PM -->
</head>
<body ng-class="{ 'mobile' : isMobile, 'desktop': !isMoble }">
...
<script src="/bundles/jquery?v=o6MgdIASviybV7bcU6AaRqYrOA0UB760vAz5vjSUKuY1"></script>

<script src="/bundles/jslibraries?v=Xa2rfZdsd6qJ7n6Hr7yiC7OVs1D0dsIdibijYENqCpw1"></script>

<script src="/bundles/application?v=owpqg70n_bI5lQwgHR3UUPPywjd6kpwviW9nJiNo1FY1"></script>

<script src="/bundles/bootstrap?v=Mq4Q_Dx-1LLYO7TzEb5esZVZo8-XncaVfkndSDy3DhM1"></script>
...
<!--[if lte IE 8]>
    <script src="https://Assets.onestore.ms/cdnfiles/onestorerolling-1610-13000/shell/common/js/shell_ie8.js"></script>
<![endif]-->



<script async src="https://mem.gfx.ms/meversion?partner=smc&market=en-US"></script>

<script src="https://Assets.onestore.ms/cdnfiles/onestorerolling-1610-13000/shell/generated/shellservice.v3.min.js"></script>
...
<script src="https://www.microsoft.com/uniblends/scripts/blender.js"></script>
    ...
    <script src="/Scripts/Lib/i18n/angular-locale_en-us.js?v=1.0.16301.7"></script>

    <div ng-if="!noChrome" ng-cloak>
            ...
            <div class="shell-header-nav-wrapper" ms.cmpgrp="nav" role="navigation">
                <ul class="shell-header-nav" role="menubar" id="srv_shellHeaderNav" data-bi-area="L1" data-bi-view="Hovermenus">
                        <li class="shell-header-user-mobile-container">
                                    ...
                                    <li class="shell-header-dropdown  " data-navcontainer="shellmenu_3_NavContainer">
                                        <div id="shellmenu_3" class="shell-header-dropdown-label">
                                            <a id="Store-navigation" href="javascript:void(0)" role="button" aria-labelledby="shellmenu_3" aria-expanded="false" ms.title="Store" data-bi-name="Store" data-bi-slot="1" tabindex="20">
                                                Store
                                            </a>
                                        </div>
...
<div class="shell-header-dropdown-content " aria-hidden="true" role="menu">
                <dl class="shell-header-dropdown-tab  " ms.cmpnm="Store; Store home">
                            ...
                            <dt id="shellmenu_4" class="shell-header-dropdown-tab-label shell-header-L2menu-direct-link">
                ...
                <dl class="shell-header-dropdown-tab  " ms.cmpnm="Store; Devices">
                            ...
                            <dt id="shellmenu_5" class="shell-header-dropdown-tab-label">
    ...
    <ul class="shell-header-dropdown-tab-list">
                ...
                <dl class="shell-header-dropdown-tab  " ms.cmpnm="Store; Software">
                            ...
                            <dt id="shellmenu_12" class="shell-header-dropdown-tab-label">
    ...
    <ul class="shell-header-dropdown-tab-list">
                ...
                <dl class="shell-header-dropdown-tab  " ms.cmpnm="Store; Apps">
                            ...
                            <dt id="shellmenu_16" class="shell-header-dropdown-tab-label">
    ...
    <ul class="shell-header-dropdown-tab-list">
                ...
                <dl class="shell-header-dropdown-tab  " ms.cmpnm="Store; Games">
                            ...
                            <dt id="shellmenu_20" class="shell-header-dropdown-tab-label">
    ...
    <ul class="shell-header-dropdown-tab-list">
                ...
                <dl class="shell-header-dropdown-tab  " ms.cmpnm="Store; Entertainment">
                            ...
                            <dt id="shellmenu_26" class="shell-header-dropdown-tab-label">
    ...
    <ul class="shell-header-dropdown-tab-list">
                ...
                <dl class="shell-header-dropdown-tab  " ms.cmpnm="Store; Business &amp; Education">
                            ...
                            <dt id="shellmenu_30" class="shell-header-dropdown-tab-label">
    ...
    <ul class="shell-header-dropdown-tab-list">
                ...
                <dl class="shell-header-dropdown-tab  " ms.cmpnm="Store; Sale">
                            ...
                            <dt id="shellmenu_34" class="shell-header-dropdown-tab-label">
    ...
    <ul class="shell-header-dropdown-tab-list">
                ...
                <dl class="shell-header-dropdown-tab  " ms.cmpnm="Store; Find a store">
                            ...
                            <dt id="shellmenu_36" class="shell-header-dropdown-tab-label shell-header-L2menu-direct-link">
                ...
                <dl class="shell-header-dropdown-tab  " ms.cmpnm="Store; Gift cards">
                            ...
                            <dt id="shellmenu_37" class="shell-header-dropdown-tab-label shell-header-L2menu-direct-link">
                                <a href="https://www.microsoft.com/en-us/store/gift-cards" ms.title="Gift cards" tabindex="20" data-bi-name="Store_GiftCards">Gift cards</a>                         
                                    ...
                                    <li class="shell-header-dropdown  " data-navcontainer="shellmenu_38_NavContainer">
                                        <div id="shellmenu_38" class="shell-header-dropdown-label">
                                            <a id="Products-navigation" href="javascript:void(0)" role="button" aria-labelledby="shellmenu_38" aria-expanded="false" ms.title="Products" data-bi-name="Products" data-bi-slot="2" tabindex="20">
                                                Products
                                            </a>
                                        </div>
...
<div class="shell-header-dropdown-content " aria-hidden="true" role="menu">
                <dl class="shell-header-dropdown-tab  " ms.cmpnm="Products; Software &amp; services">
                            ...
                            <dt id="shellmenu_39" class="shell-header-dropdown-tab-label">
    ...
    <ul class="shell-header-dropdown-tab-list">
                    <li id="shellmenu_40">
                        <a href="//www.microsoft.com/en-us/windows" class="shell-l3-list-item" ms.title="Windows" tabindex="20" data-bi-name="Products_SoftwareAndServices_Windows">
                            Windows
                        </a>
                    </li>
                    <li id="shellmenu_41">
                ...
                <dl class="shell-header-dropdown-tab  " ms.cmpnm="Products; Devices &amp; Xbox">
                            ...
                            <dt id="shellmenu_53" class="shell-header-dropdown-tab-label">
    ...
    <ul class="shell-header-dropdown-tab-list">
                ...
                <dl class="shell-header-dropdown-tab  " ms.cmpnm="Products; For business">
                            ...
                            <dt id="shellmenu_62" class="shell-header-dropdown-tab-label">
    ...
    <ul class="shell-header-dropdown-tab-list">
                ...
                <dl class="shell-header-dropdown-tab  " ms.cmpnm="Products; For developers &amp; IT pros">
                            ...
                            <dt id="shellmenu_74" class="shell-header-dropdown-tab-label">
    ...
    <ul class="shell-header-dropdown-tab-list">
                ...
                <dl class="shell-header-dropdown-tab  " ms.cmpnm="Products; For students &amp; educators">
                            ...
                            <dt id="shellmenu_80" class="shell-header-dropdown-tab-label">
    ...
    <ul class="shell-header-dropdown-tab-list">
                        ...
                        <dt>
                            <span id="meControl">
                                <div class="msame_Header" tabindex="60" style="display: inline-block; height: 48px; font-size: 14px; border: 1px solid transparent; border-bottom-style: none; width: 100%;">
                                    <div class="msame_Header_name" style="line-height: 48px; max-width: 160px; display: inline-block; vertical-align: top; font-size: 86%; color: #505050; white-space: nowrap; text-overflow: ellipsis; overflow: hidden; word-break: break-all">Sign in </div>
                                </div>
                            </span>
                        </dt>
                    </dl>
            ...
            <ul class="shell-header-toggle" ms.cmpgrp="header actions">
                                    <li>
                        <a id="shell-header-shopping-cart-mobile" href="//www.microsoftstore.com/store/msusa/en_US/DisplayThreePgCheckoutShoppingCartPage" class="shell-header-toggle-cart" title="Cart" data-bi-name="Toggle Cart" ms.title="cart" tabindex="50">
                            <i id="toggle-shell-icon-cart" class="shell-icon-cart"></i>
                            <span class="sr-only">Cart</span>
                            <span class="shopping-cart-amount"></span>
                        </a>
                    </li>
            </ul>
            ...
            <div class="shell-header-actions" ms.cmpgrp="header actions">
                    ...
                    <div class="shell-header-cart">
                        <a id="shell-header-shopping-cart" href="//www.microsoftstore.com/store/msusa/en_US/DisplayThreePgCheckoutShoppingCartPage" data-bi-name="Shopping Cart" title="Cart" ms.title="cart" tabindex="50">
                            <i class="shell-icon-cart"></i>
                            <span class="sr-only">Cart</span>
                            <span class="shopping-cart-amount"></span>
                        </a>
                    </div>
                        <iframe id="shell-cart-count" data-src="//www.microsoftstore.com/store/msusa/en_US/Content/pbPage.CartSummary" style="display: none"></iframe>
            </div>
...
<script type="text/javascript">
    ...
    <div ng-if="!noChrome && !hideSearch">
        <div ng-include="'/PartialViews/Search/SearchContainer.php'"></div>
    </div>


    <div ng-if="isDefaultPremier" ng-class='{"isDefaultPremier":commercial-hub}' ng-include="'/PartialViews/Commercial/CommercialHub.php'"></div>


        <noscript>
        <div class="error-content text-center">
            <div><span class="win-icon warning-symbol win-icon-EmojiNeutral"></span></div>
    ...
    <div class="ng-hide" ng-show="errorStatus" ng-if="errorStatus" ng-switch on="errorStatus">
        <div ng-switch-when="500" id="error500" class="error-content text-center">
            <div><span class="win-icon warning-symbol win-icon-EmojiNeutral"></span></div>
            <h2 ng-bind="(errorContent && errorContent.header) ? errorContent.header : 'An error occurred'"></h2>
            <p ng-bind="(errorContent && errorContent.caption) ? errorContent.caption : 'Please try your request again later '"></p>
        </div>
        <div ng-switch-when="404" class="error-content text-center">
            <div><span class="win-icon warning-symbol win-icon-EmojiNeutral"></span></div>
            <h2 ng-bind="(errorContent && errorContent.header) ? errorContent.header : 'Try searching for what you need'"></h2>
            <p ng-bind="(errorContent && errorContent.caption) ? errorContent.caption : 'This page doesn’t exist.'"></p>
        </div>
...
<div ng-view ng-show="!errorStatus" scroll-track>
    ...
    <div class="win-color-bg-10" ng-if="!noChrome" ng-cloak ng-class="{ 'skylight-entry-chrome-padding': hasSkylightEntry }">
        <div ng-include="'/PartialViews/Common/F1Footer.php'"></div>
        <div ng-include="'/PartialViews/Common/Locale.php'"></div>
...
<div class="shell-footer" role="contentinfo" ms.pgarea="uhffooter" data-bi-area="Footer" data-bi-view="3xLinks">
    <div class="shell-footer-wrapper">
        ...
        <div class="shell-footer-lang" ms.cmpgrp="loc picker" ms.cmpnm="loc picker" >
                <ul>
                    <li>
                        ...
                        <a id="locale-picker-link" ms.title="English (United States)" href="javascript:function smcLanguageSelector() { return undefined; } smcLanguageSelector();"
        ...
        <div class="shell-footer-copyright" ms.cmpgrp="corp links" ms.cmpnm="corp">
            <ul>
                            <li>
                                <a id="shellmenu_0" href="http://go.microsoft.com/fwlink/?LinkID=206977" ms.title="Terms of use" class="ctl_footerNavLink" data-bi-name="Footer_TermsOfUse" data-bi-slot="1">
                                    Terms of use
                                </a>
                            </li>
                            <li>
                                <a id="shellmenu_1" href="http://go.microsoft.com/fwlink/?LinkID=521839" ms.title="Privacy &amp; cookies" class="ctl_footerNavLink" data-bi-name="Footer_Privacy&amp;cookies" data-bi-slot="2">
                                    Privacy &amp; cookies
                                </a>
                            </li>
                            <li>
                                <a id="shellmenu_2" href="http://www.microsoft.com/trademarks" ms.title="Trademarks" class="ctl_footerNavLink" data-bi-name="Footer_Trademarks" data-bi-slot="3">
                                    Trademarks
                                </a>
                            </li>
    ...
    <virtual-agent-entry ng-if="hasSkylightEntry" data-view="skylightEntryView" data-message-delay="5000" data-message-duration="10000"></virtual-agent-entry>
