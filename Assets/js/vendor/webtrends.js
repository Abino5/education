...
function WebTrends() {
    ...
    this.domain = '';
    this.timezone = -5;
    this.fpcdom = ".praxair.com";
    this.onsitedoms = "";
    this.downloadtypes = "doc,docx,log,msg,pages,rtf,txt,wpd,wps,csv,dat,efx,key,pps,ppt,pptx,sdf,vcf,xml,aif,iff,m3u,m4a,mid,mp3,mpa,ra,wav,wma,3g2,3gp,asf,asx,avi,flv,mov,mp4,mpg,rm,swf,vob,wmv,zip,,xls,xlsx,pdf";
    this.navigationtag = "div,table";
    this.metanames = "Continent,Country,Category3,Category4,Category5";
