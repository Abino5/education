...
<head>
    ...
    <title>Industrial Gas Supply: Cylinder, Pipeline, Bulk, Microbulk & On-Site Gas Delivery Services | Airtec</title>

        <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="IE=EDGE" />

    <meta name="description" content="We offer flexible supply options and supply management systems that help assure a reliable, uninterrupted product supply." />
    <meta name="keywords" content="" />

    <meta property="og:title" content="Industrial Gas Supply: Cylinder, Pipeline, Bulk, Microbulk &amp; On-Site Gas Delivery Services" />
    <meta property="og:description" content="We offer flexible supply options and supply management systems that help assure a reliable, uninterrupted product supply." />
...
<meta name="VIcurrentDateTime" content="636135781194687813" />
    ...
    <div class="container">
        <div class="row">
            <ul class="crumbs clearfix">
                ...
                <li class="current">
                    <span>Gas Supply & Management</span>
                </li>
            </ul>
        </div>
    </div>
...
<div class="content-intro block">
    <div class="content clearfix">
        <div class="page-title">
            <h1>INDUSTRIAL GAS SUPPLY: CYLINDER, PIPELINE, BULK, MICROBULK & ON-SITE GAS DELIVERY SERVICES</h1>
        ...
        <div class="copy ">
            <h4>Supply that never sleeps</h4>
            <p>At Airtec, we think there&rsquo;s a lot to be said for reliability. We may not be flashy. We may not be conspicuous. But we&rsquo;re always there, quietly making things happen, providing you with the reliable supply of industrial gases you need to make your business successful. With extensive and strategically located production facilities in every major regional market, our focus on supply has given us the distinction of having one of the lowest run-out rates in the business. So whether you&rsquo;re looking for a single cylinder or thousands of tons per day, we have the experience to deliver the gases you need, the way you want it.</p>
        </div>
    </div>
</div>
</div>
...
<div class="content-wrapper clearfix">
    ...
    <div class="block-grid-row clearfix">
            <div class="item bucket ">
                <div class="header">
                <a href="http://www.airtecgulf.com/services/industrial-gas-supply-and-management/cylinders-and-liquid-containers" title="Cylinders &amp; Liquid Containers">Cylinders & Liquid Containers</a>

</div>
<div class="content">
        <p>For smaller, more specialized applications, we offer a complete line of high-pressure gas cylinders and liquid containers, quality assurance services and management tools.</p>
            ...
            <div class="item bucket ">
                <div class="header">
                <a href="http://www.airtecgulf.com/services/industrial-gas-supply-and-management/bulk-and-microbulk-delivery" title="Bulk &amp; Microbulk Delivery">Bulk & Microbulk Delivery</a>

</div>
<div class="content">
        <p>If you require large amounts of industrial gas, our bulk and microbulk delivery systems can provide a reliable, uninterrupted supply of the gases and liquids your business depends on.</p>
    ...
    <div class="block-grid-row clearfix">
            <div class="item bucket ">
                <div class="header">
                <a href="http://www.airtecgulf.com/services/industrial-gas-supply-and-management/pipeline" title="Pipeline">Pipeline</a>

</div>
<div class="content">
        <p>Ideal for customers who consume very large volumes of oxygen, nitrogen or argon each day, our pipeline supply systems may be just what you need.</p>
            ...
            <div class="item bucket ">
                <div class="header">
                <a href="http://www.airtecgulf.com/services/industrial-gas-supply-and-management/onsite-production" title="On-Site Production">On-Site Production</a>

</div>
<div class="content">
        <p>As an alternative to traditional bulk supply, we can design, build and operate a variety of on-site systems for the production of argon, nitrogen, oxygen and hydrogen.</p>
    ...
    <div class="block-grid-row clearfix">
            <div class="item bucket ">
                <div class="header">
                <a href="http://www.airtecgulf.com/services/industrial-gas-supply-and-management/mobile-nitrogen-pumping-service" title="Mobile Nitrogen Pumping Service">Mobile Nitrogen Pumping Service</a>

</div>
<div class="content">
        <p>Our fleet of mobile nitrogen pump trucks and tube trailers can deliver a continuous, dedicated supply of 99.9+% pure nitrogen, in a wide range of temperatures and pressures, for a wide range of industries and applications.</p>
            ...
            <div class="item bucket ">
                <div class="header">
                <a href="industrial-gas-supply-and-management/small-on-site-production.htm" title="Small On-site Production">Small On-site Production</a>

</div>
<div class="content">
        <p>Small on-site nitrogen and VPSA production is a good choice for those looking for fast delivery and quick installation. Airtec, in connection with Praxair, Inc., builds, owns, and operates the plant at your site connected to your pipeline. You simply provide the utilities and pay for the products you use via a convenient and budget-friendly pricing plan.</p>
...
<div><div class="sidebar-block toggler open">
    <dl class="subnav">
      <dt class="trigger">Gas Supply & Management<span class="toggler-icon">-</span></dt>
      <dd class="toggle-wrapper">
        <ul>
            <li>
                <a href="http://www.airtecgulf.com/services/industrial-gas-supply-and-management/cylinders-and-liquid-containers" title="Cylinders &amp; Liquid Containers"><span>Cylinders & Liquid Containers</span></a>
            </li>
            <li>
                <a href="http://www.airtecgulf.com/services/industrial-gas-supply-and-management/bulk-and-microbulk-delivery" title="Bulk &amp; Microbulk Delivery"><span>Bulk & Microbulk Delivery</span></a>
            </li>
            <li>
                <a href="http://www.airtecgulf.com/services/industrial-gas-supply-and-management/pipeline" title="Pipeline"><span>Pipeline</span></a>
            </li>
            <li>
                <a href="http://www.airtecgulf.com/services/industrial-gas-supply-and-management/onsite-production" title="On-Site Production"><span>On-Site Production</span></a>
            </li>
            <li>
                <a href="http://www.airtecgulf.com/services/industrial-gas-supply-and-management/mobile-nitrogen-pumping-service" title="Mobile Nitrogen Pumping Service"><span>Mobile Nitrogen Pumping Service</span></a>
            </li>
            <li>
                <a href="industrial-gas-supply-and-management/small-on-site-production.htm" title="Small On-Site Production"><span>Small On-Site Production</span></a>
            </li>
        </ul>
      </dd>
