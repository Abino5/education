...
<head>
    ...
    <title>Industrial Gas Supply, Equipment, & Services for the Refining Industry | Airtec</title>

        <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="IE=EDGE" />

    <meta name="description" content="Produce cleaner transportation fuels with our industrial gases, technologies and services. With 50 years experience, we know how to get gases to you safely and efficiently." />
    <meta name="keywords" content="" />

    <meta property="og:title" content="Industrial Gas Supply, Equipment, &amp; Services for the Refining Industry" />
    <meta property="og:description" content="Produce cleaner transportation fuels with our industrial gases, technologies and services. With 50 years experience, we know how to get gases to you safely and efficiently." />
...
<meta name="VIcurrentDateTime" content="636135782963716473" />
...
<li>
    <img src='../-/media/praxairus/images/3_0-industry/3_15-refining/3_15_plantwithguy_1400x490.jpg' alt='Plant with man walking' />
</li>            </ul>
        </div>
    </div>
...
<div class="tab-nav-holder paneled">
    <ul class="resp-tabs-list tab-nav tab-nav-header-desktop clearfix">
            <li class="">
                <a href="refining_2.php" title="Overview" data-browser-title="Industrial Gas Supply and Equipment for the Refining Industry">
Overview                </a>
                <span class="carrot">&nbsp;</span>
            </li>
            <li class="">
                <a href="refining_4.php" title="Related Gases" data-browser-title="Industrial Gases (Hydrogen, Oxygen, Nitrogen) for the Refining Industry">
Related Gases                </a>
                <span class="carrot">&nbsp;</span>
            </li>
            <li class="active">
                <a href="refining_3.php" title="Applications" data-browser-title="Industrial Applications &amp; Solutions for the Refining Industry">
Applications                </a>
                <span class="carrot">&nbsp;</span>
            </li>
            <li class="">
                <a href="refining_5.php" title="Services" data-browser-title="Industrial Services for the Refining Industry">
Services                </a>
                <span class="carrot">&nbsp;</span>
            </li>
    </ul>
...
<div class="content tab-row clearfix">
    <div class="page-title">
        <h1>INDUSTRIAL GAS SUPPLY AND EQUIPMENT FOR THE REFINING INDUSTRY</h1>
...
<div class="content tab-row clearfix">
    <div>
        <h2>Refining expectations</h2>
        <p>With over 50 years of experience supplying and supporting refineries in the Gulf Cooperation Council countries, Airtec can help your refinery succeed in today&rsquo;s challenging environment. Airtec plays an essential, effective and responsible role through continuous supplies of nitrogen gas through pipelines. &nbsp;&nbsp;</p>
...
<div class="content tab-row clearfix">
    <div>
        ...
        <p>See how we serve related industries.</p>
            ...
            <li>
                <a href="energy.php" title="Energy" class="with_arrow">Energy</a>
            </li>
            <li>
                <a href="laboratories.php" title="Laboratories" class="with_arrow">Laboratories</a>
            </li>
            <li>
                <a href="become-a-volunteer.php" title="Oil &amp; Gas" class="with_arrow">Oil & Gas</a>
            </li>
            <li>
...
<div class="content">
    <div class="page-title">
            <h1>INDUSTRIAL GASES FOR THE REFINING INDUSTRY</h1>
        ...
        <div class="ind_gases-content block-grid">
                ...
                <div class="block-grid-row clearfix">
                        <div class="gas item">
                                ...
                                <div class="content">
                                    <p>Hydrogen is essential in today&rsquo;s refining industry for upgrading heavy crude oils into refined fuels, and helping to meet increasingly tighter transportation fuel specifications.</p>
                                </div>
                        </div>
                        <div class="gas item">
                                <h2>
                                ...
                                <div class="content">
                                    <p>Oxygen is widely used in refineries to increase the capacity of Fluid Catalytic Cracking (FCC) plants and Sulfur Recovery Units (SRU), increase process heater and hydrogen plant capacity and efficiencies, and to improve wastewater treatment operations.</p>
                                </div>
                        </div>
                ...
                <div class="block-grid-row clearfix">
                        <div class="gas item">
                                ...
                                <div class="content">
                                    <p>An industrial gas used to blanket storage tanks and purge pipelines, nitrogen can also strip Volatile Organic Compounds (VOCs) from wastewater and reduce VOC emissions.</p>
                                </div>
                        </div>
            ...
            <div class="content">
                <div class="row">
                        <div class="column twelve">
                            <ul>
                                    <li><a href='../gases/carbon-dioxide.php' class='with_arrow' target='Active Browser' >Carbon Dioxide</a></li>
                            </ul>
                        </div>
                </div>
            </div>
...
<div class="content tab-row page-title clearfix">
    <h1>INDUSTRIAL APPLICATIONS FOR THE REFINING INDUSTRY</h1>
...
<div class="content copy tab-row clearfix">
    <div>
        <h2>Fluid Catalytic Cracker (FCC) Emissions Reduction</h2>
        <p>Reduce CO and NOx emissions up to 60% and increase the operational flexibility of your Fluid Catalytic Cracking unit with our proprietary CONOx application.</p>
    </div>
</div>

<div class="content copy tab-row clearfix">
    <div>
        <h2>Fluid Catalytic Cracker (FCC) Oxygen Enrichment</h2>
        <p>Improve the regenerator capacity of your Fluid Catalytic Cracker (FCC) Unit by up to 35% with our oxygen enrichment technology.</p>
    </div>
</div>
...
<div class="content copy tab-row clearfix">
    <div>
        ...
        <p>Applying our oxy-fuel combustion technology to your fired heater will decrease fuel consumption and increase capacity, ultimately improving heater efficiency and reducing NOx emissions. Oxy-fuel combustion is a great way of debottlenecking a heater with minimal capital outlay.</p>
    </div>
</div>

<div class="content copy tab-row clearfix">
    <div>
        <h2>Oxygen Enhanced Reforming</h2>
        <p>Achieve 10-15% incremental hydrogen production from your steam methane reformer (SMR) using oxygen injection in the combustion side of the reformer.</p>
    </div>
</div>

<div class="content copy tab-row clearfix">
    <div>
        <h2>Refinery Gas Processing</h2>
        <p>Turn almost any refinery fuel gas stream, including those with high levels of olefins and heavier hydrocarbons, into an acceptable steam methane reformer (SMR) or gas-turbine feed. This technology is also a great alternative to standard hydrotreating for reducing organic sulfur levels in fuel gas to meet increasingly stringent environmental goals. Hydrogen and LPG fractions can also be recovered from refinery fuel gas streams with our refinery gas processing technology.</p>
    </div>
</div>

<div class="content copy tab-row clearfix">
    <div>
        <h2>Sulfur Plant Oxygen Enrichment</h2>
        <p>Increase your Sulfur Recovery Unit (SRU) capacity oxygen injection.</p>
    </div>
</div>
...
<div class="content copy tab-row clearfix">
    <div>
        ...
        <p>Using the same liquid nitrogen source that is already used in the refinery for blanketing and purging, this industrial application can condense VOCs in a process stream, returning valuable products back to your operation and preserving the nitrogen for purging and blanketing operations.</p>
    </div>
</div>
...
<div class="content tab-row page-title clearfix">
    <h1>INDUSTRIAL SERVICES FOR THE REFINING INDUSTRY</h1>
...
<div class="content tab-row two-col clearfix">
        <div class="odd">
            <h2>SMR Energy Performance Management</h2>
            <p>We&rsquo;ve harnessed our decades of SMR experience to develop a unique productivity toolset to help you identify and respond to factors impacting your productivity and efficiency, so you can operate at your peak.</p>
        </div>

        <div class="even">
            <h2>Hydrogen and Energy Optimization</h2>
            <p>Our specialists will work directly with you to identify valuable optimization opportunities for your refinery hydrogen system and energy usage, and develop a strategy to improve your overall efficiency.</p>
        </div>
</div>
...
<div class="content tab-row headline clearfix">
    <div>
        ...
        <p>We do more than provide industrial gases, supply systems and applications to the refining industry. We work with you to optimize every step of your process. From consultation to implementation and use, we offer a range of industrial services that help you monitor and manage your industrial gas supplies, hydrogen and refinery fuel gas balances, and improve the overall operation of your refinery.</p>
            <ul class="no-bullets">
