...
<head>
    ...
    <title>Industrial Gas Supply, Technology & Services for the Pulp & Paper Industry | Airtec</title>

        <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="IE=EDGE" />

    <meta name="description" content="We give a whole new meaning to the term “clean slate.”  Check out how our pulp and paper industrial technology is helping make paper cleaner." />
    <meta name="keywords" content="" />

    <meta property="og:title" content="Industrial Gas Supply, Technology &amp; Services for the Pulp &amp; Paper Industry" />
    <meta property="og:description" content="We give a whole new meaning to the term “clean slate.”  Check out how our pulp and paper industrial technology is helping make paper cleaner." />
...
<meta name="VIcurrentDateTime" content="636135781302483122" />
...
<li>
    <img src='../-/media/praxairus/images/3_0-industry/3_14-pulp-and-paper/3_14_papermill_1400x490.jpg' alt='Paper mill' />
</li>            </ul>
        </div>
    </div>
...
<div class="tab-nav-holder paneled">
    <ul class="resp-tabs-list tab-nav tab-nav-header-desktop clearfix">
            <li class="active">
                <a href="http://www.airtecgulf.com/industries/pulp-and-paper?tab=overview" title="Overview" data-browser-title="Industrial Gas Supply and Services for the Pulp &amp; Paper Industry">
Overview                </a>
                <span class="carrot">&nbsp;</span>
            </li>
            <li class="">
                <a href="http://www.airtecgulf.com/industries/pulp-and-paper?tab=related-gases" title="Related Gases" data-browser-title="Industrial Gases (Carbon Dioxide, Oxygen) for the Pulp &amp; Paper Industry">
Related Gases                </a>
                <span class="carrot">&nbsp;</span>
            </li>
            <li class="">
                <a href="http://www.airtecgulf.com/industries/pulp-and-paper?tab=applications" title="Applications" data-browser-title="Industrial Applications &amp; Solutions for the Pulp &amp; Paper Industry">
Applications                </a>
                <span class="carrot">&nbsp;</span>
            </li>
            <li class="">
                <a href="http://www.airtecgulf.com/industries/pulp-and-paper?tab=services" title="Services" data-browser-title="Industrial Services for the Pulp &amp; Paper Industry">
Services                </a>
                <span class="carrot">&nbsp;</span>
            </li>
    </ul>
...
<div class="content tab-row clearfix">
    <div class="page-title">
        <h1>INDUSTRIAL GAS SUPPLY AND SERVICES FOR THE PULP & PAPER INDUSTRY</h1>
...
<div class="content tab-row clearfix">
    <div>
        <h2>Rewriting the rules on clean paper</h2>
        <p>A clean sheet of paper can inspire an idea. But at Airtec, our ideas are inspiring cleaner paper. As new environmental regulations are being rolled out to address pulp and paper mill emissions, more and more companies are turning to Airtec for a solution. We offer strategies and industrial services that are both economical and environmentally conscious. Our industrial gas and gas dissolution expertise provide mills with the means to raise production, lower operating costs and meet the latest environmental standards. Let us help you make your paper cleaner.</p>
    </div>
</div>
<div class="content tab-row clearfix">
    <div>
...
<div class="content">
    <div class="page-title">
            <h1>INDUSTRIAL GASES (CARBON DIOXIDE, OXYGEN) FOR THE PULP & PAPER INDUSTRY</h1>
        ...
        <div class="ind_gases-content block-grid">
                ...
                <div class="block-grid-row clearfix">
                        <div class="gas item">
                                ...
                                <div class="content">
                                    <p>Carbon dioxide is an industrial gas used in the pulp and paper industry to control pH levels, enhance chlorine dioxide bleaching efficiency and wash brownstock and bleached stock.</p>
                                </div>
                        </div>
                        <div class="gas item">
                                <h2>
                                ...
                                <div class="content">
                                    <p>As an industrial gas, oxygen helps you lower the bleaching cost, meet stringent environmental regulations through use in delignification, oxidative extraction and wastewater treatment.</p>
                                </div>
                        </div>
...
<div class="content tab-row page-title clearfix">
    <h1>INDUSTRIAL APPLICATIONS AND SOLUTIONS FOR THE PULP & PAPER INDUSTRY</h1>
...
<div class="content copy tab-row clearfix">
    <div>
        <h2>Delignification & Bleaching</h2>
        <p>Take the steps toward environmental friendly pulp production with oxygen delignification and oxygen bleaching industrial solutions.</p>
    </div>
</div>
...
<div class="content copy tab-row clearfix">
    <div>
        <h2>Washing</h2>
        <p>Increase production rates for bleached kraft pulp by up to 15% with our CO<sub>2</sub> brownstock washing technology, or debottleneck the recovery system's operation .</p>
    </div>
</div>

<div class="content copy tab-row clearfix">
    <div>
        <h2>White Liquor Oxidation</h2>
        <p>Our oxygen can be used to enable efficient oxidation of white liquor &mdash; generating alkali sources that are useful in bleaching and delignification processes.</p>
    </div>
</div>

<div class="content copy tab-row clearfix">
    <div>
        <h2>Wet End pH Control & Adjustment</h2>
        <p>Control pH with carbon dioxide in the stock preparation and wet end stages of your alkaline, neutral and tissue papermaking processes.</p>
    </div>
</div>
...
<div class="content tab-row page-title clearfix">
    <h1>INDUSTRIAL SERVICES FOR THE PULP & PAPER INDUSTRY</h1>
