...
<head>
    ...
    <title>Industrial Gas Supply & Equipment for the Commercial & Technical Diving Industry | Airtec</title>

        <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="IE=EDGE" />

    <meta name="description" content="Discover our full range of diving equipment, gases, and supply options so you can start exploring without limits." />
    <meta name="keywords" content="" />

    <meta property="og:title" content="Industrial Gas Supply &amp; Equipment for the Commercial &amp; Technical Diving Industry" />
    <meta property="og:description" content="Discover our full range of diving equipment, gases, and supply options so you can start exploring without limits." />
...
<meta name="VIcurrentDateTime" content="636135781240551519" />
...
<li>
    <img src='../-/media/praxairus/images/3_0-industry/3_4-diving/3_4_deepseadiving_1400x490.jpg' alt='Deep sea diving' />
</li>            </ul>
        </div>
    </div>
...
<div class="tab-nav-holder paneled">
    <ul class="resp-tabs-list tab-nav tab-nav-header-desktop clearfix">
            <li class="active">
                <a href="http://www.airtecgulf.com/industries/diving?tab=overview" title="Overview" data-browser-title="Industrial Gas and Equipment for the Diving Industry">
Overview                </a>
                <span class="carrot">&nbsp;</span>
            </li>
            <li class="">
                <a href="http://www.airtecgulf.com/industries/diving?tab=related-gases" title="Related Gases" data-browser-title="Industrial Gases (Helium, Oxygen, Nitrogen, Argon) for the Diving Industry">
Related Gases                </a>
                <span class="carrot">&nbsp;</span>
            </li>
            <li class="">
                <a href="http://www.airtecgulf.com/industries/diving?tab=products" title="Products" data-browser-title="Industrial Products &amp; Technology for the Diving Industry">
Products                </a>
                <span class="carrot">&nbsp;</span>
            </li>
            <li class="">
                <a href="http://www.airtecgulf.com/industries/diving?tab=services" title="Services" data-browser-title="Industrial Services for the Diving Industry">
Services                </a>
                <span class="carrot">&nbsp;</span>
            </li>
    </ul>
...
<div class="content tab-row clearfix">
    <div class="page-title">
        <h1>INDUSTRIAL GAS AND EQUIPMENT FOR THE DIVING INDUSTRY</h1>
...
<div class="content tab-row clearfix">
    <div>
        <h2>Exploring without limits</h2>
        <p>They say the oceans are the last frontier. At Airtec, we give you the gases, equipment and supply systems you need to explore the depths worry-free. Our joint-venture partner, Praxair, Inc., developed the first breathing mixture tables in the 1920s, and has been advancing the diving industry ever since. &nbsp;So whether you&rsquo;re diving for commercial or technical purposes, we are knowledgeable about which gases blend most effectively for the depths you&rsquo;re planning to travel.</p>
    </div>
</div>
<div class="content tab-row clearfix">
    <div>
...
<div class="content">
    <div class="page-title">
            <h1>INDUSTRIAL GASES FOR THE DIVING INDUSTRY</h1>
        ...
        <div class="ind_gases-content block-grid">
                ...
                <div class="block-grid-row clearfix">
                        <div class="gas item">
                                ...
                                <div class="content">
                                    <p>Gaseous helium is an industrial carrier gas for oxygen in synthetic breath mixtures, enabling deep-sea divers to conduct scientific explorations and develop offshore oil and gas resources.</p>
                                </div>
                        </div>
                        <div class="gas item">
                                <h2>
                                ...
                                <div class="content">
                                    <p>Oxygen is an essential component of every breathing gas mixture. Mixes that contain less than 21% oxygen are used in technical diving as deep breathing gas.</p>
                                </div>
                        </div>
                ...
                <div class="block-grid-row clearfix">
                        <div class="gas item">
                                ...
                                <div class="content">
                                    <p>Nitrogen, the main component of air, is the most affordable and most common industrial gas for shallow diving.</p>
                                </div>
                        </div>
                        <div class="gas item">
                                <h2>
                                ...
                                <div class="content">
                                    <p>Because of its thermal insulation properties, argon is used to inflate dry suits for deep sea diving.</p>
                                </div>
                        </div>
...
<div class="content tab-row page-title clearfix">
    <h1>INDUSTRIAL PRODUCTS FOR THE DIVING INDUSTRY</h1>
...
<div class="product item">
    ...
    <div class="content copy">
        ...
        <p>From cylinder floor stands to high-pressure hoses and custom gas regulation equipment, we offer a full line of industrial products and technologies to make sure your divers are as safe as possible.</p>
...
<div class="content tab-row page-title clearfix">
    <h1>INDUSTRIAL SERVICES FOR THE DIVING INDUSTRY</h1>
...
<div class="content tab-row headline clearfix">
    <div>
        ...
        <p>We do more than provide industrial gases and products to the diving industry. We work with you to optimize every step of your process. From consultation to implementation and use, we offer a range of industrial services that help you monitor and manage your gas supply and improve your process.</p>
            <ul class="no-bullets">
