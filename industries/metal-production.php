...
<head>
    ...
    <title>Industrial Gas Supply, Technology & Equipment for the Metal Production Industry | Airtec</title>

        <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="IE=EDGE" />

    <meta name="description" content="At Airtec, we have a proven history of collaboration with the steel industry. Trust us to provide the technologies you need to boost your process." />
    <meta name="keywords" content="" />

    <meta property="og:title" content="Industrial Gas Supply, Technology &amp; Equipment for the Metal Production Industry" />
    <meta property="og:description" content="At Airtec, we have a proven history of collaboration with the steel industry. Trust us to provide the technologies you need to boost your process." />
...
<meta name="VIcurrentDateTime" content="636135781296867158" />
...
<li>
    <img src='../-/media/praxairus/images/3_0-industry/3_11-metal-production/3_11_steelmill_1400x490.jpg' alt='steel mill' />
</li><li>
    <img src='../-/media/praxairus/images/3_0-industry/3_11-metal-production/3_11_largebridge_1400x490.jpg' alt='Large Bridge' />
</li>            </ul>
        </div>
    </div>
...
<div class="tab-nav-holder paneled">
    <ul class="resp-tabs-list tab-nav tab-nav-header-desktop clearfix">
            <li class="active">
                <a href="http://www.airtecgulf.com/industries/metal-production?tab=overview" title="Overview" data-browser-title="Industrial Gas Supply, Technology &amp; Equipment for Metal Production">
Overview                </a>
                <span class="carrot">&nbsp;</span>
            </li>
            <li class="">
                <a href="http://www.airtecgulf.com/industries/metal-production?tab=related-gases" title="Related Gases" data-browser-title="Industrial Gases (Argon, Oxygen, Nitrogen) for the Metal Production Industry">
Related Gases                </a>
                <span class="carrot">&nbsp;</span>
            </li>
            <li class="">
                <a href="http://www.airtecgulf.com/industries/metal-production?tab=applications" title="Applications" data-browser-title="Industrial Applications &amp; Systems for the Metal Production Industry">
Applications                </a>
                <span class="carrot">&nbsp;</span>
            </li>
            <li class="">
                <a href="http://www.airtecgulf.com/industries/metal-production?tab=services" title="Services" data-browser-title="Industrial Services for the Metal Production Industry">
Services                </a>
                <span class="carrot">&nbsp;</span>
            </li>
    </ul>
...
<div class="content tab-row clearfix">
    <div class="page-title">
        <h1>INDUSTRIAL GAS SUPPLY, TECHNOLOGY & EQUIPMENT FOR METAL PRODUCTION</h1>
...
<div class="content tab-row clearfix">
    <div>
        <h2>Strengthening your process</h2>
        <p>As the preeminent outsourced gas supplier to the metal production industry, we at Airtec are proud to supply hundreds of steel and non-ferrous mills worldwide with industrial gases that help skyscrapers soar, trains run, and ships sail. Airtec's industrial gases are used extensively in metal production to lower cost, improve energy efficiency, deliver environmental benefits, and improve productivity.</p>
<p>But our relationship with our customers goes much deeper than just industrial supply. We offer a wide range of services that include the design, build, start-up and support of applications equipment. And we provide everything from cylinders to on-site systems to integrated mills, mini mills, steel mills, foundries and non-ferrous mills for combustion processes. When you get all of your solutions from one industrial gas supplier, you have the time and the freedom to focus to on your business.</p>
    </div>
</div>
<div class="content tab-row clearfix">
    <div>
...
<div class="content">
    <div class="page-title">
            <h1>INDUSTRIAL GASES FOR THE METAL PRODUCTION INDUSTRY</h1>
        ...
        <div class="ind_gases-content block-grid">
                ...
                <div class="block-grid-row clearfix">
                        <div class="gas item">
                                ...
                                <div class="content">
                                    <p>Oxygen is a component of metal processing, and is used to replace or enrich air, ultimately increasing combustion efficiency in both ferrous and non-ferrous metal production.</p>
                                </div>
                        </div>
                        <div class="gas item">
                                <h2>
                                ...
                                <div class="content">
                                    <p>A key component of stainless steel refining, argon helps to prevent oxidation of molten steel as is used as a stirring agent.</p>
                                </div>
                        </div>
                ...
                <div class="block-grid-row clearfix">
                        <div class="gas item">
                                ...
                                <div class="content">
                                    <p>A carrier and purge gas in steel production, nitrogen is used to prevent oxidation and can be used in the heat-treating process.</p>
                                </div>
                        </div>
                        <div class="gas item">
                                <h2>
                                ...
                                <div class="content">
                                    <p>Hydrogen is used to prevent oxydation and is the key component in the heat treating process.</p>
                                </div>
                        </div>
...
<div class="content tab-row page-title clearfix">
    <h1>INDUSTRIAL APPLICATIONS FOR THE METAL PRODUCTION INDUSTRY</h1>
...
<div class="content copy tab-row clearfix">
    <div>
        <h2>Argon Oxygen Decarburization</h2>
        <p>Over 75% of the world&rsquo;s stainless steel is made with our Argon Oxygen Decarburization (AOD) process. Lower your material costs, produce cleaner metals and increase productivity with AOD.</p>
    </div>
</div>
...
<div class="content copy tab-row clearfix">
    <div>
        ...
        <p>Used in foundries, mini mills and stainless steel mills, our joint venture partner, Praxair, Inc.'s <em>CoJet</em>&reg; gas injection and Supersonic direct injection processes lower costs and improve furnace productivity.</p>
    </div>
</div>
...
<div class="content copy tab-row clearfix">
    <div>
        ...
        <p>Our Dilute Oxygen Combustion system helps convert your furnace air-fuel burners into oxy-fuel burners &mdash; increasing productivity, and decreasing fuel consumption, operating costs and emissions.</p>
    </div>
</div>
...
<div class="content copy tab-row clearfix">
    <div>
        <h2>Heat Treating</h2>
        <p>From annealing and brazing to sintering and carburizing, our nitrogen and hydrogen-based heat-treating processes are low in cost, high in productivity, and help your operators precisely meet specifications.</p>
    </div>
</div>

<div class="content copy tab-row clearfix">
    <div>
        <h2>Hot Oxygen Technology</h2>
        <p>Our hot oxygen system rapidly burns hard to combust materials and easily preheats oxygen to high temperatures at point of use.</p>
    </div>
</div>
...
<div class="content copy tab-row clearfix">
    <div>
        <h2>Inerting</h2>
        <p>Our Laminar Barrier Inerting technology reduces alloy oxidation, slag formation, and dissolved oxygen, nitrogen, and hydrogen in metals to produce better fluidity, easier casting and fewer flaws.</p>
    </div>
</div>

<div class="content copy tab-row clearfix">
    <div>
        <h2>Stove Oxygen Enrichment</h2>
        <p>Generate higher blast temperatures without burning more fuel. With our Stove Oxygen Enrichment application, we can help you reduce or potentially eliminate the need for fuels like coke oven gas and natural gas.</p>
    </div>
</div>
...
<div class="content tab-row page-title clearfix">
    <h1>INDUSTRIAL SERVICES FOR THE METAL PRODUCTION INDUSTRY</h1>
