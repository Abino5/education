...
<head>
    ...
    <title>Industrial Gas Supply, Technology, & Services for the Energy Industry | Airtec</title>

        <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="IE=EDGE" />

    <meta name="description" content="Discover our full range of gases, applications and services that help the energy industry increase productivity, lower costs and reduce emissions." />
    <meta name="keywords" content="" />

    <meta property="og:title" content="Industrial Gas Supply, Technology, &amp; Services for the Energy Industry" />
    <meta property="og:description" content="Discover our full range of gases, applications and services that help the energy industry increase productivity, lower costs and reduce emissions." />
...
<meta name="VIcurrentDateTime" content="636135781252095445" />
...
<li>
    <img src='../-/media/praxairus/images/3_0-industry/3_6-energy/3_6_bubbleplants_1400x490.jpg' alt='bubbles and plants montage' />
</li>            </ul>
        </div>
    </div>
...
<div class="tab-nav-holder paneled">
    <ul class="resp-tabs-list tab-nav tab-nav-header-desktop clearfix">
            <li class="active">
                <a href="http://www.airtecgulf.com/industries/energy?tab=overview" title="Overview" data-browser-title="Industrial Gas Supply &amp; Technology for the Energy Industry">
Overview                </a>
                <span class="carrot">&nbsp;</span>
            </li>
            <li class="">
                <a href="http://www.airtecgulf.com/industries/energy?tab=related-gases" title="Related Gases" data-browser-title="Industrial Gases for the Energy Industry">
Related Gases                </a>
                <span class="carrot">&nbsp;</span>
            </li>
            <li class="">
                <a href="http://www.airtecgulf.com/industries/energy?tab=applications" title="Applications" data-browser-title="Industrial Applications for the Energy Industry">
Applications                </a>
                <span class="carrot">&nbsp;</span>
            </li>
            <li class="">
                <a href="http://www.airtecgulf.com/industries/energy?tab=services" title="Services" data-browser-title="Industrial Services for the Energy Industry">
Services                </a>
                <span class="carrot">&nbsp;</span>
            </li>
    </ul>
...
<div class="content tab-row clearfix">
    <div class="page-title">
        <h1>INDUSTRIAL GAS SUPPLY & TECHNOLOGY FOR THE ENERGY INDUSTRY</h1>
...
<div class="content tab-row clearfix">
    <div>
        <h2>Powering the world forward</h2>
        <p>Everywhere you look, our joint-venture partner, Praxair, Inc., has gases and applications that are hard at work powering the industries that support our everyday lives. From supplying the hydrogen that powers cars, buses and forklifts, to building and operating world-class oxygen supply units for gasification, to aiding in the production of the next generation of biofuels and bio-based chemicals, together we are delivering more value to our customers with lower total cost of ownership. Because while it's critical to meet today's energy needs, it's even more important to meet the demands of tomorrow. That&rsquo;s why we continue to develop and advance industrial applications, supply systems and technologies that reduce emissions and improve efficiency, to power a cleaner future.</p>
    </div>
</div>
<div class="content tab-row clearfix">
    <div>
...
<p><a href="oil-and-gas.htm" target="_self" class="with_arrow">Oil &amp; Gas</a>&nbsp;<br />
<a href="refining.htm" target="_self" class="with_arrow">Refining</a><br />
<a href="water-and-wastewater-treatment.htm" target="_self" class="with_arrow">Water and Wastewater Treatment</a></p>
...
<div class="content">
    <div class="page-title">
            <h1>INDUSTRIAL GASES FOR THE ENERGY INDUSTRY</h1>
        ...
        <div class="ind_gases-content block-grid">
                ...
                <div class="block-grid-row clearfix">
                        ...
                        <div class="gas item">
                                ...
                                <div class="content">
                                    <p>Utilizing oxygen in the place of air can increase performance and capital efficiency in many industries. It is often used in boilers and process heaters, industrial fermenters and gasification processes to improve productivity.</p>
                                </div>
                        </div>
                ...
                <div class="block-grid-row clearfix">
                        <div class="gas item">
                                ...
                                <div class="content">
                                    <p>Hydrogen is the energy source in fuel cells. It is also used in biofuel and chemical processing, and can improve utility generator-cooling performance.</p>
                                </div>
                        </div>
                        <div class="gas item">
                                <h2>
                                ...
                                <div class="content">
                                    <p>Carbon dioxide is used as a reactant in several biological processes for the production of important chemical building blocks.</p>
                                </div>
                        </div>
            ...
            <div class="content">
                <div class="row">
                        <div class="column twelve">
                            <ul>
                                    <li><a href='../gases/argon.htm' class='with_arrow' target='Active Browser' >Argon</a></li>
                                    <li><a href='../gases/helium.htm' class='with_arrow' target='Active Browser' >Helium</a></li>
                                    <li><a href='http://www.airtecgulf.com/gases/sulfur-hexafluoride' class='with_arrow' target='Active Browser' >Sulfur Hexafluoride</a></li>
                            </ul>
                        </div>
                </div>
            </div>
...
<div class="content tab-row page-title clearfix">
    <h1>INDUSTRIAL APPLICATIONS FOR THE ENERGY INDUSTRY</h1>
...
<div class="content copy tab-row clearfix">
    <div>
        ...
        <p>Oxygen-Enhanced Combustion applications can help lower NOx emissions in your industrial boilers, furnaces and fired heaters by up to 70%. And when burning high-moisture high-ash fuels, this technology can increase output to nameplate capacity, while stabilizing and improving flame performance. Regardless of the application, Oxygen-Enhanced Combustion is designed to help you generate cleaner power, faster.</p>
    </div>
</div>

<div class="content copy tab-row clearfix">
    <div>
        <h2>Nitrogen Stripping</h2>
        <p>Remove harmful dissolved gases from your process fluids with our nitrogen stripping application. Together we can tailor a system that will meet your purity requirements.</p>
    </div>
</div>
...
<div class="content copy tab-row clearfix">
    <div>
        ...
        <p>Direct Oxygen Injection technology improves oxygen transfer rates, production capacity and productivity. It also reduces foaming and flooding in your oxygen-limited aerobic fermentation and propagation reactors.</p>
    </div>
</div>
...
<div class="content copy tab-row clearfix">
    <div>
        ...
        <p>Using liquid nitrogen as an indirect refrigerant, this application can condense Volatile Organic Compounds (VOCs) in your process streams, returning valuable products back to your business while utilizing the nitrogen for purging and blanketing operations.</p>
    </div>
</div>

<div class="content copy tab-row clearfix">
    <div>
        <h2>Oxygen for Gasification</h2>
        <p>With years of experience designing, building and operating commercial air separation units, Airtec has the technology and world-class engineering talent required to deliver the most efficient, reliable and competitively-priced oxygen supply for your gasification needs.</p>
    </div>
</div>

<div class="content copy tab-row clearfix">
    <div>
        <h2>Hydrogen for Fuel Cells</h2>
        <p>We&rsquo;ve been providing hydrogen fuel and related technical support to fuel-cell developers and vehicle fleets for years. And as the technologies become even more widespread, we are even better suited to supply the hydrogen and fueling systems your facility requires.</p>
    </div>
</div>
...
<div class="content tab-row page-title clearfix">
    <h1>INDUSTRIAL SERVICES FOR THE ENERGY INDUSTRY </h1>
...
<div class="content tab-row headline clearfix">
    <div>
        ...
        <p>We do more than provide industrial gases and applications to the energy industry. We will help you to optimize every step of your process. From consultation to implementation and use, we offer a range of industrial services that help you monitor and manage your gas supply so you can focus on being as productive and efficient as possible.</p>
            <ul class="no-bullets">
