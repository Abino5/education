...
<div class="tab-nav-holder paneled">
    <ul class="resp-tabs-list tab-nav tab-nav-header-desktop clearfix">
            <li class="active">
                <a href="electronics_2.php" title="Overview" data-browser-title="Industrial Gas Supply &amp; Equipment for the Electronics Industry">
Overview                </a>
                <span class="carrot">&nbsp;</span>
            </li>
            <li class="">
                <a href="electronics_3.php" title="Related Gases" data-browser-title="Industrial Gases for the Electronics Industry">
Related Gases                </a>
                <span class="carrot">&nbsp;</span>
            </li>
            <li class="">
    ...
    <div class="page-title">
        ...
        <div class="ind_gases-content block-grid">
                ...
                <div class="block-grid-row clearfix">
                        <div class="gas item">
                                <h2>
                                            <a href="../gases/silane.php" title="Silane">
                        ...
                        <div class="gas item">
                                <h2>
                                            <a href="../gases/ammonia.php" title="Ammonia">
            ...
            <div class="content">
                <div class="row">
                        <div class="column twelve">
                            <ul>
                                    <li><a href='../gases/oxygen.php' class='with_arrow' target='Active Browser' >Oxygen</a></li>
                            </ul>
                        </div>
                </div>
            </div>
