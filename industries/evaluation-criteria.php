...
<head>
    ...
    <title>Industrial Gas Supply, Systems & Services for the Aerospace & Aircraft Industry | Airtec</title>

        <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="IE=EDGE" />

    <meta name="description" content="Explore the wide range of industrial gases and applications Airtec offers to the aerospace and aircraft industries." />
    <meta name="keywords" content="" />

    <meta property="og:title" content="Industrial Gas Supply, Systems &amp; Services for the Aerospace &amp; Aircraft Industry" />
    <meta property="og:description" content="Explore the wide range of industrial gases and applications Airtec offers to the aerospace and aircraft industries." />
...
<meta name="VIcurrentDateTime" content="636135781234311559" />
...
<li>
    <img src='../-/media/praxairus/images/3_0-industry/3_1-aerospace-and-aircraft/3_1_airplane_1400x490.jpg' alt='airplane' />
</li>            </ul>
        </div>
    </div>
...
<div class="tab-nav-holder paneled">
    <ul class="resp-tabs-list tab-nav tab-nav-header-desktop clearfix">
            <li class="active">
                <a href="http://www.airtecgulf.com/industries/aerospace-and-aircraft?tab=overview" title="Overview" data-browser-title="Industrial Gas Supply for the Aerospace &amp; Aircraft Industry">
Overview                </a>
                <span class="carrot">&nbsp;</span>
            </li>
            <li class="">
                <a href="http://www.airtecgulf.com/industries/aerospace-and-aircraft?tab=related-gases" title="Related Gases" data-browser-title="Industrial gases for the aerospace &amp; aircraft industry">
Related Gases                </a>
                <span class="carrot">&nbsp;</span>
            </li>
            <li class="">
                <a href="http://www.airtecgulf.com/industries/aerospace-and-aircraft?tab=applications" title="Applications" data-browser-title="Industrial Applications for the Aerospace &amp; Aircraft Industry">
Applications                </a>
                <span class="carrot">&nbsp;</span>
            </li>
            <li class="">
                <a href="http://www.airtecgulf.com/industries/aerospace-and-aircraft?tab=services" title="Services" data-browser-title="Industrial Services for the Aerospace &amp; Aircraft Industry">
Services                </a>
                <span class="carrot">&nbsp;</span>
            </li>
    </ul>
...
<div class="content tab-row clearfix">
    <div class="page-title">
        <h1>INDUSTRIAL GAS SUPPLY FOR THE AEROSPACE & AIRCRAFT INDUSTRY</h1>
...
<div class="content tab-row clearfix">
    <div>
        <h2>Innovation grounded in experience</h2>
        <p>At Airtec, we&rsquo;ve been deeply involved in aerospace and aircraft development. Today, our industrial gases, services and supply systems allow our customers to meet environmental and safety standards, reduce operating costs, and most importantly, continue to push the boundaries. We support rocket launch programs that are making commercial space travel a reality. And we supply gases and liquids to testing facilities to make sure you get where you need to go safely. At Airtec, we work hard on the ground to help your business take off.</p>
    </div>
</div>
<div class="content tab-row clearfix">
    <div>
        <h3></h3>
        <p>See how we serve similar industries</p>
            <ul class="no-bullets">
            <li>
...
<div class="content">
    <div class="page-title">
            <h1>INDUSTRIAL GASES FOR THE AEROSPACE & AIRCRAFT INDUSTRY</h1>
        ...
        <div class="ind_gases-content block-grid">
                ...
                <div class="block-grid-row clearfix">
                        ...
                        <div class="gas item">
                                ...
                                <div class="content">
                                    <p>Used as a power source, industrial hydrogen fuels rockets and powers life-support systems and computers in space environments. It is also used for metal sintering and annealing.</p>
                                </div>
                        </div>
                ...
                <div class="block-grid-row clearfix">
                        <div class="gas item">
                                ...
                                <div class="content">
                                    <p>Our liquid oxygen has prepared and launched many bipropellant vehicles since the early 1960&rsquo;s. We also supply gaseous oxygen to support fuel rocket combustion.</p>
                                </div>
                        </div>
                        <div class="gas item">
                                <h2>
                                ...
                                <div class="content">
                                    <p>Argon is a versatile industrial gas used in the production of light bulbs and lasers, and in welding applications. As an inert gas, it can also be used in heat treating and autoclaving processes.</p>
                                </div>
                        </div>
                ...
                <div class="block-grid-row clearfix">
                        <div class="gas item">
                                ...
                                <div class="content">
                                    <p>Helium is used as a lift gas, in both the liquid and gas form, to purge and pressurize liquid hydrogen fuel systems and detect leaks.</p>
                                </div>
                        </div>
...
<div class="content tab-row page-title clearfix">
    <h1>INDUSTRIAL APPLICATIONS FOR THE AEROSPACE & AIRCRAFT INDUSTRY</h1>
...
<div class="content copy tab-row clearfix">
    <div>
        <h2>Heat Treating</h2>
        <p>From annealing and brazing to sintering and carburizing, our nitrogen-based heat- treating applications are low in cost, high in productivity, and help you meet the stringent standards of the aerospace &amp; aircraft industry.</p>
    </div>
</div>
...
<div class="content copy tab-row clearfix">
    <div>
        <h2>Forging</h2>
        <p>Our proprietary Dilute Oxygen Combustion burners are used to provide even heating in critical preheating processes for the forging of exotic alloys for jet engines and other critical aerospace and aircraft parts.</p>
    </div>
</div>

<div class="content copy tab-row clearfix">
    <div>
        <h2>Autoclave Inerting</h2>
        <p>At Airtec, we design and install customized systems to provide the high pressure, high flow rates required for autoclave inerting.</p>
    </div>
</div>
...
<div class="content copy tab-row clearfix">
    <div>
        <h2></h2>
        <p>See how other industrial applications apply to aerospace &amp; aircraft.</p>
...
<div class="content tab-row page-title clearfix">
    <h1>INDUSTRIAL SERVICES FOR THE AEROSPACE & AIRCRAFT INDUSTRY</h1>
...
<div class="content tab-row headline clearfix">
    <div>
        ...
        <p>We do more than provide industrial gases, applications and products to the aerospace &amp; aircraft industry. We offer high performance surface coatings that increase performance by reducing harmful effects of abrasion, oxidation, corrosion, wear and extreme heat on commercial and military aircraft engines and airframe parts and accessories for fixed-wing aircrafts and helicopters.&nbsp;</p>
<p>We also tailor our supply systems to meet your needs and improve performance. From high volume systems and high pressure pumping technology that deliver reliable supply and reduce loss, to pressure testing and cleaning services that help maintain tank and piping integrity, we help you get the most out of your supply.&nbsp;</p>
<p>At Airtec, we work with you to optimize every step of your manufacturing process. From consultation to implementation and use, we offer a range of industrial services that help you monitor and manage your gas supply so you can improve your product quality.</p>
            <ul class="no-bullets">
